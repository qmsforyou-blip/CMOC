...
def main() -> None:
    with tempfile.TemporaryDirectory() as td:
        ...
        store.append(
            JournalEvent(
                run_id="RUN-BACKUP-001",
                event_id="EVENT-RUN-BACKUP-001-001",
                event_seq=1,
                stage_id="RUN",
                event_type="RUN_CREATED",
                stage_result_id="RUN-RESULT-RUN-BACKUP-001",
                attempt_id="ATTEMPT-RUN-BACKUP-001",
                event_status="ACTIVE",
                traceability=trace,
                source_id="SRC-BACKUP-001",
                batch_id="PKG-BACKUP-001",
            ),
            source_id="SRC-BACKUP-001",
            batch_id="PKG-BACKUP-001",
        )
        store.append(
            JournalEvent(
                run_id="RUN-BACKUP-001",
                event_id="EVENT-RUN-BACKUP-001-002",
                event_seq=2,
                stage_id="DISCOVERY",
        ...
        persistence[key] = {
            ...
            "stage_id": "DISCOVERY",
            "attempt_id": "ATTEMPT-DISCOVERY-BACKUP-001",
            "result_id": "RESULT-DISCOVERY-BACKUP-001",
            "status": "ACCEPT",
        }
        store.close()
